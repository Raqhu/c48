...
function setup() {
  ...
  MazeEnd = createSprite(795,590,10,80);
  MazeEnd.shapeColor = color('Green');
  ...
  powercoin = createSprite(260,640,50,50);
  powercoin.addImage(powerpimg);
  powercoin.scale = 0.1;
 ...
 // text (mouseX+','+mouseY,mouseX,mouseY);
  ...
  player1.collide(wall50);
    ...
    if(player1.collide(speedCoin)){
      speedCoin.destroy();
       speedcoincollision += 1;
    }

    if(player1.collide(powercoin)){
      playerHealth =5;
   ...
   //
    ...
    if(player1.collide(MazeEnd)){
      swal(
        {
          title: `You win!!`,
          text: "You got to the end of the maze without dying!!!",
          imageUrl:
    ...
    if(playerHealth === 0){
      swal(
        {
          title: `Game Over!!!`,
          text: "Oops, you didnt get to the end of the maze without dying!!!",
          imageUrl:
    ...
    textFont('Forte');
    fill('Blue')
    text('Health:'+ playerHealth,70,840);
    ...
    textFont('Forte');
    fill(255, 204, 0);
    text('Get to the end of the maze without dying!', 230,780);
...
function handleghost (){
  player1.overlap(ghostgrp,function(collecter,collected){
    if(playerHealth>0){
